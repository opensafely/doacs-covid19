...
af_dose=pd.read_csv("../output/filtered/measure_doacs_dose_match_rate.csv", usecols=["date", "af_&_crcl", "on_doac", "dose_match", "value"])
...
#plt.ylim(ymin=0)
plt.gca()
plt.savefig(f'../output/filtered/dose_match.png')