...
# Data for this report has been run on the TPP system which covers approximately 40% of all practices, with a total population of approximately 18.6m Jan-18, rising to approximately 20.8m Sep-23.
...
plt.annotate(f"{y1_coordinates.iloc[0]:,}", xy=(x1_coordinates.iloc[0], y1_coordinates.iloc[0]), xytext=(40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{y1_coordinates.iloc[-1]:,}", xy=(x1_coordinates.iloc[-1], y1_coordinates.iloc[-1]), xytext=(-40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))
...
plt.xlim(xmin="2018-01-01", xmax="2023-09-01")
...
plt.xlabel('Period')
title = 'Number of people per 100,000 population prescribed a DOAC by Region; Jan18-Sep23'
plt.title('\n'.join(wrap(title,40)), fontsize=12)
plt.gca().xaxis.set_major_locator(mdates.MonthLocator(interval=1))
plt.gca().xaxis.set_major_formatter(dtFmt)
plt.vlines(
...
plt.xlabel('Period')
title = 'Number of people per 100,000 population prescribed a DOAC by age band; Jan18-Sep23'
plt.title('\n'.join(wrap(title,40)), fontsize=12)
plt.gca().xaxis.set_major_locator(mdates.MonthLocator(interval=1))
plt.gca().xaxis.set_major_formatter(dtFmt)
plt.vlines(
...
plt.annotate(f"{pivot_sex2.iloc[0, 0]:,}", xy=(pivot_sex2.index[0], pivot_sex2.iloc[0, 0]), xytext=(40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{pivot_sex2.iloc[-1, 0]:,}", xy=(pivot_sex2.index[-1], pivot_sex2.iloc[-1, 0]), xytext=(-40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))

plt.annotate(f"{pivot_sex2.iloc[0, 1]:,}", xy=(pivot_sex2.index[0], pivot_sex2.iloc[0, 1]), xytext=(40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{pivot_sex2.iloc[-1, 1]:,}", xy=(pivot_sex2.index[-1], pivot_sex2.iloc[-1, 1]), xytext=(-40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))
...
plt.ylabel('No. of people per 100,000 population')
plt.xlabel('Period')
title = 'Number of people per 100,000 population prescribed a DOAC by gender; Jan18-Sep23'
plt.title('\n'.join(wrap(title,40)), fontsize=12)
plt.gca().xaxis.set_major_locator(mdates.MonthLocator(interval=1))
plt.gca().xaxis.set_major_formatter(dtFmt)
plt.vlines(
...
plt.annotate(f"{y1_coordinates.iloc[0]:.1f}", xy=(x1_coordinates.iloc[0], y1_coordinates.iloc[0]), xytext=(40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{y1_coordinates.iloc[-1]:.1f}", xy=(x1_coordinates.iloc[-1], y1_coordinates.iloc[-1]), xytext=(-40,40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))

plt.annotate(f"{y2_coordinates.iloc[0]:.1f}", xy=(x2_coordinates.iloc[0], y2_coordinates.iloc[0]), xytext=(40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{y2_coordinates.iloc[-1]:.1f}", xy=(x2_coordinates.iloc[-1], y2_coordinates.iloc[-1]), xytext=(-40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))
...
plt.annotate(f"{pivot_carer.iloc[0, 0]:.2f}", xy=(pivot_carer.index[0], pivot_carer.iloc[0, 0]), xytext=(40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=0', 
                            color='red'))

plt.annotate(f"{pivot_carer.iloc[-1, 0]:.2f}", xy=(pivot_carer.index[-1], pivot_carer.iloc[-1, 0]), xytext=(-40,-40), 
            textcoords='offset points', ha='center', va='bottom',
            bbox=dict(boxstyle='round,pad=0.2', fc='yellow', alpha=1),
            arrowprops=dict(arrowstyle='->', connectionstyle='arc3,rad=-0', 
                            color='red'))
...
weight_subset=weight_df.loc[(weight_df["on_doac"] != 0) & (weight_df["date"] >= '2022-10-01'), :]
...
egfr_subset=egfr_df.loc[(egfr_df["on_doac"] != 0) & (egfr_df["date"] >= '2022-10-01'), :]
...
crcl_subset=crcl_df.loc[(crcl_df["on_doac"] != 0) & (crcl_df["date"] >= '2022-10-01'), :]
...
crcl2_subset=crcl2_df.loc[(crcl2_df["on_doac"] != 0) & (crcl2_df["date"] >= '2022-10-01'), :]
...
af_crcl=pd.read_csv("../output/filtered/measure_doacs_with_af_and_crcl_recorded_rate.csv", usecols=["date", "population", "on_doac", "af_&_crcl", "value"], parse_dates=["date"])
af_crcl['value'] = (100 * af_crcl['value'])
afcrcl_subset=af_crcl.loc[(af_crcl["on_doac"] != 0) & (af_crcl["date"] >= '2022-10-01'), :]
...
evaluate_subset=af_evaluate.loc[(af_evaluate["dose_summary"] != "0") & (af_evaluate["date"] >= '2022-10-01'), :]
